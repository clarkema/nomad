...
--
-- Temp. hack to support mapping Caps Lock to both Ctrl and Esc.
--
-- This stopgap allows the restoration of sanity while Karibiner Elements sorts itself
-- out and matures on macOS Sierra.
--
-- See https://github.com/tekezo/Karabiner-Elements/issues/8
