...
(setq org-capture-templates
      `(("i" "Interrupt" entry (file+olp "~/org/cbd/cbd.org" ,(current-week-monday) "Interrupts")
         "* TODO %?\n"
         :clock-in t
         :clock-keep t)
        ("a" "Ad-hoc" entry (file+olp "~/org/cbd/cbd.org" ,(current-week-monday) "Ad-hoc")
         "* TODO %?\n")
        ("n" "Ad-hoc, clock in" entry (file+olp "~/org/cbd/cbd.org" ,(current-week-monday) "Ad-hoc")
         "* IN-PROGRESS %?\n"
         :clock-in t
         :clock-keep t)
